...
async def play(c: Client, m: Message):
    ...
    keyboard = InlineKeyboardMarkup(
                  [[
                      ...
                      InlineKeyboardButton("• Channel", url=f"https://t.me/KayXChannel"),
                      InlineKeyboardButton("• Group", url=f"https://t.me/KayzuSupport"),
                  ],[
        ...
        if len(m.command) < 2:
         await m.reply_photo(
                    ...
                    [
                        [
                            InlineKeyboardButton("~ Channel ~", url=f"https://t.me/KayXChannel"),
                            InlineKeyboardButton("~ Support ~", url=f"https://t.me/KayzuSupport")
                        ],
                        [
                            InlineKeyboardButton("🗑 Close", callback_data="cls")
                        ]
